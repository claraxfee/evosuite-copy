 ...
 */
 ...
 public class StringPrimitiveStatement extends PrimitiveStatement<String> {
      ...
      */
     @Override
     public void randomize() {//only 1 of 2 constant pools is used
         if (Randomness.nextDouble() >= Properties.PRIMITIVE_POOL)
             value = Randomness.nextString(Randomness.nextInt(Properties.STRING_LENGTH));
         else {
             ConstantPool constantPool = ConstantPoolManager.getInstance().getConstantPool();//one of 2 constant pools can be returned
